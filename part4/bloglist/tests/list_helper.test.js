...
describe('favorite blog', () => {
  ...
  test('when list only has one blog, equals only entry', () => {
    const result = listHelper.favoriteBlog(listWithOneBlog);
    expect(result).toEqual(listWithOneBlog[0]);
  });

  test('of a bigger list, picks correct entry', () => {
...
describe('author with most blogs', () => {
  ...
  test('when list only has one blog, equals one blog from only author', () => {
